...
var MultiStep = ({ size, currentStep = 1 }) => {
  return /* @__PURE__ */ jsxs3(MultiStepContainer, { children: [
    ...
    /* @__PURE__ */ jsx4(Steps, { css: { "--steps-size": size }, children: Array.from({ length: size }, (_, indice) => indice + 1).map(
      (step, index) => /* @__PURE__ */ jsx4(Step, { active: currentStep >= step }, `step-${index}`)
    ) })
  ] });
};
